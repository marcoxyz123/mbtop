...
namespace Theme {
	...
	//? mbtop Default Theme - Based on Nord palette with enhanced colors
	const std::unordered_map<string, string> Default_theme = {
		...
		{ "cached_mid", "#88C0D0" },
		{ "cached_end", "#A8E0F0" },
		{ "available_start", "#4E4520" },
		{ "available_mid", "#EBCB8B" },
		{ "available_end", "#F5DBA8" },
		{ "used_start", "#5E3535" },
		{ "used_mid", "#BF616A" },
		{ "used_end", "#D08080" },
		...
		{ "upload_mid", "#B48EAD" },
		{ "upload_end", "#D8B4D8" },
		{ "process_start", "#81A1C1" },
		{ "process_mid", "#88C0D0" },
		{ "process_end", "#ECEFF4" },
		{ "proc_pause_bg", "#BF616A" },
		{ "proc_follow_bg", "#5E81AC" },
		{ "proc_banner_bg", "#B48EAD" },
		{ "proc_banner_fg", "#ECEFF4" },
		{ "followed_bg", "#5E81AC" },
		{ "followed_fg", "#ECEFF4" },
